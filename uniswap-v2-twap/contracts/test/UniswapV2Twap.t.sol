...
contract UniswapTwapTest is Test {
    ...
    function testVerifyTwapForkRecent() public {
        ...
        inputs[0] = "cat";
        inputs[1] = "../circuits/data/mainnet_0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc_98b7f6_fbe975_evm.calldata";
        ...
        IAxiomV0.BlockHashWitness memory startBlock = IAxiomV0.BlockHashWitness({
            ...
            numFinal: 1024,
            merkleProof: [
                bytes32(0xde070395104149caf62754d14993be5c368ef8c62a13b6eb9f005c64f7126585),
    ...
    function testVerifyTwapForkProof() public {
        ...
        string[] memory inputs = new string[](2);
        inputs[0] = "cat";
        inputs[1] = "../circuits/data/mainnet_0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc_98b7f6_fa62d5_evm.calldata";
        bytes memory proof = vm.ffi(inputs);
        ...
        IAxiomV0.BlockHashWitness memory endBlock = IAxiomV0.BlockHashWitness({
            ...
            numFinal: 1024,
            merkleProof: [
                bytes32(0xae3da582dee4e487d9e5a430a605b2ab318a179fda1e29e81ec773bea14e2520),
