...
contract UniswapV2TwapV1 is Ownable {
    ...
    function calculateUniswapV2Twap(
        ...
        require(
            storageProofs[2].slot == 10 && storageProofs[3].slot == 10,
            "invalid cumulative price slot"
        );
        require(
            storageProofs[0].blockNumber == storageProofs[2].blockNumber &&
                storageProofs[0].blockNumber == blockProofs[0].blockNumber,
            "inconsistent block number"
        );
        require(
            storageProofs[1].blockNumber == storageProofs[3].blockNumber &&
                storageProofs[1].blockNumber == blockProofs[1].blockNumber,
            "inconsistent block number"
        );
        require(
        ...
        ) = _unpackReserveValues(storageProofs[1].value);
