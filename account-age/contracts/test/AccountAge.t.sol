...
contract AccountAgeTest is Test {
    ...
    function testVerifyAgeFork() public {
        ...
        inputs[0] = "cat";
        inputs[1] = "../circuits/data/mainnet_0xd20beba9efa30fb34af93af5c91c9a4d6854eac4_6e372e_evm.calldata";
        ...
        if (accountAge.birthBlocks(account) != currBlock.blockNumber) {
            revert("Account age not verified");
        }
    }
}
